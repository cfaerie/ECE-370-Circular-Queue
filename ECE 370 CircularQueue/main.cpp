...
float EVALUATE_POSTFIX(CQueue myQueue)
{
        ...
        string s;
        int i,n,qs;
        char currentChar,Vchar,nextChar;
...
int main()
{
    ...
    cout << "Original Working code: "<<endl;
    INFIX_TO_POSTFIX(cq,cs,filename);


    //testing new string type queue.
    //It is able to work with strings and convert to numbers.
    //Might need string to char for operation symbols? Maybe not.
    cout << "\n\n\nRevised Code: "<<endl;
